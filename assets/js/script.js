...
var quizQuestions = [{
    ...
    choiceA: "Language made of 2's and 3's",
    choiceB: "High level language",
    choiceC: "Language made of 1's and 0's",
    choiceD: "None of these",
    correctAnswer: "c"},
  {
    question: "One loop inside the body of another loop is called?",
    choiceA: "Nested",
    choiceB: "Loop in loop",
    choiceC: "Double loops",
    choiceD: "Loopty loop",
    correctAnswer: "a"},
   {
    ...
    correctAnswer: "b"},
    {
    question: "What is the name for a character in Scratch?",
    choiceA: "Character",
    choiceB: "Scratcher",
    choiceC: "Script",
    choiceD: "Sprite",
    correctAnswer: "d"},
    {
    question: "What does this equation mean? a!=1",
    choiceA: "A is not equal to t",
    choiceB: "A is assigned to t",
    choiceC: "A and t are equal",
    choiceD: "T is added to a",
    correctAnswer: "a"},  
    {
    question: "What is the correct syntax for a comment in Javascipt?",
    choiceA: "<< comment",
    choiceB: "?? comment",
    choiceC: "// comment",
    choiceD: "## comment",
    ...
    choiceA: "Continuum Syntax Standard",
    choiceB: "Cascading Style Sheets",
    choiceC: "Cascaded Serial Syntax",
    choiceD: "Concave Selector Standard",
    correctAnswer: "b"},
...
// This function clears the local storage of the high scores and clears the text from the high score board
function clearScore(){
